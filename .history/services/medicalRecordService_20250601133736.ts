import { Allergy, AllergyForm, Appointment, AppointmentForm, Medication, MedicationForm, Treatment, TreatmentForm, Vaccination, VaccinationForm } from '../components/medical/types';
