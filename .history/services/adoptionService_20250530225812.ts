...
const adoptionService = {
  ...
  getAdoptionListingById: async (id: string): Promise<AdoptionListing> => {
    try {
      ...
      const listing = await response.json();
      console.log('Raw adoption listing response:', listing);
      ...
      const processedListing = {
        ...
        imageUrl: listing.photoPath ? `${API_BASE_URL}${listing.photoPath}` : undefined,
        createdAt: listing.createdAt
      };

      console.log('Processed adoption listing:', processedListing);
