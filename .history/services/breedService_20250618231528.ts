...
class BreedService {
  ...
  async getBreedsByAnimalType(animalType: 'DOG' | 'CAT'): Promise<ApiResponse<Breed[]>> {
    try {
      const response = await fetch(`http://localhost:8080/api/breeds/by-animal-type/${animalType}`);
  ...
  async getBreedsByAnimalTypeQuery(animalType: 'DOG' | 'CAT'): Promise<ApiResponse<Breed[]>> {
    try {
      const response = await fetch(`http://localhost:8080/api/breeds?animalType=${animalType}`);
  ...
  async getAnimalTypes(): Promise<ApiResponse<AnimalType[]>> {
    try {
      const response = await fetch('http://localhost:8080/api/breeds/animal-types');
