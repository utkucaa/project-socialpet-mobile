...
import { getHealthRecords } from '../services/medicalRecordService';
...
export default function PetProfileScreen() {
  ...
  const loadHealthRecords = async () => {
    ...
    try {
      ...
      const records = await getHealthRecords(pet.id, selectedCategory.type);
  ...
  const handleAddRecord = () => {
    if (pet) {
      router.push(`/add-medical-record?petId=${pet.id}&type=${selectedCategory.type}`);
    }
  };
