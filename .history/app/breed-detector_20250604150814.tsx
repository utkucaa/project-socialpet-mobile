          ...
          <Animated.View style={[styles.resultSection, { transform: [{ scale: scaleAnim }] }]}>
            ...
            >
              ...
              <View style={styles.resultContent}>
                ...
                <View style={styles.resultItem}>
                  <Text style={styles.resultLabel}>Ana Cins:</Text>
                ...
                {result.topPredictions && selectedAnimal === 'dog' && (
                  <View style={styles.topPredictionsSection}>
                    <Text style={styles.resultLabel}>En Yüksek Tahminler:</Text>
                    <View style={styles.predictionsList}>
                      {Object.entries(result.topPredictions)
                        .sort(([,a], [,b]) => b - a)
                        .slice(0, 3)
                        .map(([breed, confidence], index) => (
                          <View key={breed} style={styles.predictionItem}>
                            <View style={styles.predictionInfo}>
                              <Text style={styles.predictionRank}>#{index + 1}</Text>
                              <Text style={styles.predictionBreed}>{breed}</Text>
                            </View>
