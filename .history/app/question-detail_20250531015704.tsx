      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.rightSidebar}>
          <View style={styles.askQuestionSection}>
            <Text style={styles.sidebarTitle}>SORUNUZ MU VAR?</Text>
            ...
            >
              <Text style={styles.askQuestionBtnText}>Yeni Soru Sor</Text>
            </TouchableOpacity>
          </View>

          <View style={styles.donationSection}>
            <Text style={styles.donationMainTitle}>SOCIALPET</Text>
            <Text style={styles.donationSubTitle}>BARINAKLARA BAĞIŞ</Text>
            
            <View style={styles.donationStats}>
              <Text style={styles.donationStatsTitle}>BUGÜNE KADAR</Text>
              <Text style={styles.donationAmount}>95,806 KG</Text>
              <Text style={styles.donationStatsText}>MAMA BAĞIŞLANDI</Text>
            </View>
            
            <View style={styles.donationFeatures}>
              <Text style={styles.featureText}>✓ Şeffaftır, bağışçılar listelenir.</Text>
              <Text style={styles.featureText}>✓ Güvenilirdir, ulaştırılan mamalar fotoğraflanır, yayınlanır.</Text>
              <Text style={styles.featureText}>✓ Bağışlanan toplam mama miktarını herkes takip edebilir.</Text>
            </View>
          </View>
        </View>
      </ScrollView>
