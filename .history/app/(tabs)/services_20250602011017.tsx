...
const mockCities: City[] = [
  {
    ...
    ilceler: [
      ...
      { ilce_adi: 'Üsküdar', plaka_kodu: '34', ilce_kodu: '04', il_adi: 'İstanbul' },
      { ilce_adi: 'Beyoğlu', plaka_kodu: '34', ilce_kodu: '05', il_adi: 'İstanbul' },
    ]
  },
  {
    il_adi: 'Ankara',
    ...
    ilceler: [
      ...
      { ilce_adi: 'Yenimahalle', plaka_kodu: '06', ilce_kodu: '03', il_adi: 'Ankara' },
      { ilce_adi: 'Mamak', plaka_kodu: '06', ilce_kodu: '04', il_adi: 'Ankara' },
    ]
  },
  {
    il_adi: 'İzmir',
    plaka_kodu: '35',
    ilceler: [
      { ilce_adi: 'Konak', plaka_kodu: '35', ilce_kodu: '01', il_adi: 'İzmir' },
      { ilce_adi: 'Karşıyaka', plaka_kodu: '35', ilce_kodu: '02', il_adi: 'İzmir' },
      { ilce_adi: 'Bornova', plaka_kodu: '35', ilce_kodu: '03', il_adi: 'İzmir' },
    ]
  }
];
...
const mockBusinesses: Business[] = [
  ...
  {
    place_id: '3',
    name: 'Ankara Hayvan Hastanesi',
    type: 'Veteriner',
    rating: 4.8,
    vicinity: 'Çankaya, Ankara',
    city: 'Ankara',
    district: 'Çankaya',
    formatted_phone_number: '+90 312 456 78 90',
    mainPhotoUrl: 'https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=800&h=600&fit=crop',
    opening_hours: {
      open_now: true,
      weekday_text: ['Pazartesi: 08:00-19:00', 'Salı: 08:00-19:00']
    },
    services: ['24 Saat Acil', 'Cerrahi', 'Röntgen'],
  },
  {
    place_id: '4',
    name: 'Pet World Mağazası',
    type: 'Petshop',
    rating: 4.0,
    vicinity: 'Keçiören, Ankara',
    city: 'Ankara',
    district: 'Keçiören',
    formatted_phone_number: '+90 312 111 22 33',
    mainPhotoUrl: 'https://images.unsplash.com/photo-1560807707-8cc77767d783?w=800&h=600&fit=crop',
    opening_hours: {
      open_now: true,
      weekday_text: ['Pazartesi: 09:00-21:00', 'Salı: 09:00-21:00']
    },
    services: ['Pet Maması', 'Aksesuar', 'Kuaför'],
  }
];
...
export default function ServicesScreen() {
  ...
  useEffect(() => {
    ...
    console.log('Cities loaded:', mockCities);
  }, []);
  ...
  useEffect(() => {
    ...
    if (selectedCity) {
      ...
      if (city) {
        ...
        console.log('Districts set:', city.ilceler);
      } else {
        setDistricts([]);
      }
      setSelectedDistrict('');
