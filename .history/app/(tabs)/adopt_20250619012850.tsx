...
const citiesData: City[] = require('../../assets/il-ilce.json');
...
export default function AdoptScreen() {
  ...
  const [cities] = useState(citiesData.map(city => city.il_adi));
  ...
  useEffect(() => {
    if (formData.city) {
      const selectedCity = citiesData.find(city => city.il_adi === formData.city);
      if (selectedCity) {
