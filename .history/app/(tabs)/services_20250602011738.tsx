      ...
      >
        ...
        >
          <View style={styles.dropdownModal}>
            ...
            >
              <Text style={[styles.dropdownItemText, selectedType === 'Veteriner' && styles.selectedItem]}>
                Veteriner
              </Text>
            </TouchableOpacity>
            <TouchableOpacity 
            ...
            >
              <Text style={[styles.dropdownItemText, selectedType === 'Petshop' && styles.selectedItem]}>
                Petshop
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.dropdownModalLarge}>
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  <Text style={[styles.dropdownItemText, selectedCity === item.il_adi && styles.selectedItem]}>
                    {item.il_adi}
                  </Text>
                </TouchableOpacity>
              )}
          ...
          <View style={styles.dropdownModalLarge}>
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  <Text style={[styles.dropdownItemText, selectedDistrict === item.ilce_adi && styles.selectedItem]}>
                    {item.ilce_adi}
                  </Text>
                </TouchableOpacity>
              )}
