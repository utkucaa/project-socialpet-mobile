...
export default function AdoptScreen() {
  ...
  const showCitySelector = () => {
    ...
    setShowPetDropdown(false); // Close other dropdown
  };

  const selectPetType = (type: string) => {
    setSearchFilter({...searchFilter, petType: type});
    setShowPetDropdown(false);
  };

  const selectCity = (city: string) => {
    setSearchFilter({...searchFilter, city: city});
      ...
      case 1:
        return (
          <View style={styles.stepContent}>
            ...
            <Text style={styles.stepSubtitle}>Bilgilendirme</Text>
            ...
            <View style={styles.infoBox}>
              <Text style={styles.infoText}>
                Sadece ücretsiz sahiplendirmeler için ilan verilebilir. Evcil hayvan arıyorsanız 'arıyorum' içerikli ilanlar açmak yerine sahiplendirme ilanlarına bakabilirsiniz. Böylelikle yuva arayan dostlarımıza daha kolay ulaşmış olursunuz. Sahiplendirme ilanları için tıklayınız.
                {'\n\n'}
      ...
      case 2:
        return (
          <ScrollView style={styles.stepContent} showsVerticalScrollIndicator={false}>
            ...
            <Text style={styles.stepSubtitle}>İlan Bilgileri</Text>
      ...
      case 3:
        return (
          <View style={styles.stepContent}>
            ...
            <Text style={styles.stepSubtitle}>Fotoğraf Seçimi</Text>
      ...
      case 4:
        return (
          <ScrollView style={styles.stepContent} showsVerticalScrollIndicator={false}>
            ...
            <Text style={styles.stepSubtitle}>İlan Kontrolü</Text>
