...
export default function HomeScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      await apiService.storeToken(response.accessToken);
      await apiService.storeUserData(response);

      // Başarılı giriş mesajı
      Alert.alert(
        'Başarılı!', 
        `Hoş geldiniz ${response.firstName}!`,
        [
          {
            text: 'Tamam',
      ...
      Alert.alert(
        'Giriş Hatası', 
        error.message || 'Giriş yapılırken bir hata oluştu. E-posta ve şifrenizi kontrol ediniz.'
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Kayıt Başarılı!', 
        `Hoş geldiniz ${response.firstName}! Hesabınız oluşturuldu.`,
        [
          {
            text: 'Tamam',
            onPress: () => router.replace('/home')
      ...
      Alert.alert(
        'Kayıt Hatası', 
        error.message || 'Kayıt olunurken bir hata oluştu. Bilgileri kontrol edip tekrar deneyiniz.'
      );
    } finally {
      setLoading(false);
    }
