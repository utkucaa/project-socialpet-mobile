...
export default function AdoptScreen() {
  ...
  const showPetTypeSelector = () => {
    const options = ['İptal', 'Tümü', ...petTypes];
    ...
    if (Platform.OS === 'ios') {
      ActionSheetIOS.showActionSheetWithOptions(
        {
          options,
          cancelButtonIndex,
          title: 'Pet Türü Seçin',
        },
        (buttonIndex) => {
          if (buttonIndex !== cancelButtonIndex) {
            const selectedValue = buttonIndex === 1 ? '' : petTypes[buttonIndex - 2];
            setSearchFilter({...searchFilter, petType: selectedValue});
          }
        }
      );
    } else {
      Alert.alert(
        ...
        [
          ...
          { text: 'Tümü', onPress: () => setSearchFilter({...searchFilter, petType: ''}) },
          ...petTypes.map(type => ({
            text: type,
            onPress: () => setSearchFilter({...searchFilter, petType: type})
          }))
        ]
      );
    }
  ...
  const showCitySelector = () => {
    const options = ['İptal', 'Tümü', ...cities];
    const cancelButtonIndex = 0;
    ...
    if (Platform.OS === 'ios') {
      ActionSheetIOS.showActionSheetWithOptions(
        ...
        (buttonIndex) => {
          if (buttonIndex !== cancelButtonIndex) {
            const selectedValue = buttonIndex === 1 ? '' : cities[buttonIndex - 2];
            setSearchFilter({...searchFilter, city: selectedValue});
          }
        }
      );
    } else {
      Alert.alert(
        ...
        [
          { text: 'İptal', style: 'cancel' },
          { text: 'Tümü', onPress: () => setSearchFilter({...searchFilter, city: ''}) },
          ...cities.map(city => ({
            text: city,
            onPress: () => setSearchFilter({...searchFilter, city: city})
          }))
        ]
      );
    }
            ...
            <View style={styles.filterItem}>
              ...
              <View style={styles.pickerWrapper}>
                <Picker
                  ...
                  onValueChange={showPetTypeSelector}
                  style={styles.pickerStyle}
                >
            ...
            <View style={styles.filterItem}>
              ...
              <View style={styles.pickerWrapper}>
                <Picker
                  ...
                  onValueChange={showCitySelector}
                  style={styles.pickerStyle}
                >
                  <Picker.Item label="Tümü" value="" />
                </Picker>
