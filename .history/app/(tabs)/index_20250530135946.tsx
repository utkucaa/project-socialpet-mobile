...
export default function HomeScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      await storage.set('token', authData.accessToken);
      await storage.set('user', JSON.stringify(authData.user));

      // Başarılı giriş mesajı
      Alert.alert(
        'Başarılı!', 
        `Hoş geldiniz ${authData.user.firstName}!`,
        [
          {
            text: 'Tamam',
      ...
      const errorMessage = error.response?.data?.message || error.response?.data?.error || 'Giriş yapılırken bir hata oluştu. E-posta ve şifrenizi kontrol ediniz.';
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Kayıt Başarılı!', 
        `Hoş geldiniz ${authData.user.firstName}! Hesabınız oluşturuldu.`,
        [
          {
            text: 'Tamam',
            onPress: () => router.replace('/home')
      ...
      const errorMessage = error.response?.data?.message || error.response?.data?.error || 'Kayıt olunurken bir hata oluştu. Bilgileri kontrol edip tekrar deneyiniz.';
