      ...
      case 'header':
        return (
          ...
          >
            ...
            {/* Quick Vaccination Access Button */}
            <TouchableOpacity 
              style={styles.quickVaccinationButton} 
              onPress={handleVaccinationPress}
              activeOpacity={0.8}
            >
              <LinearGradient
                colors={['#10B981', '#059669']}
                style={styles.quickVaccinationGradient}
              >
                <Text style={styles.quickVaccinationIcon}>💉</Text>
                <Text style={styles.quickVaccinationText}>Aşı Kayıtları</Text>
              </LinearGradient>
            </TouchableOpacity>
          </LinearGradient>
        );
        ...
        return (
          <View style={styles.recordsSection}>
            <LinearGradient
              ...
              style={styles.recordsHeaderContainer}
            >
              <View style={styles.recordsHeaderContent}>
                <View style={styles.recordsHeaderLeft}>
                  <Text style={styles.recordsHeaderIcon}>{item.category.icon}</Text>
                  <Text style={styles.recordsTitle}>{item.category.title}</Text>
                </View>
                <TouchableOpacity style={styles.addButton} onPress={handleAddRecord}>
                  <LinearGradient
                    colors={item.category.gradientColors as any}
      ...
      case 'empty':
        return (
          <View style={styles.emptyRecords}>
            <LinearGradient
              colors={['#FFFFFF', '#F8FAFC']}
              style={styles.emptyRecordsContainer}
            >
