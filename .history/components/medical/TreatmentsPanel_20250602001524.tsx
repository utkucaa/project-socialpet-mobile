...
const DateTimePickerModals: React.FC<{
  ...
  console.log('🗓️ TreatmentsPanel DateTimePickerModals render - showDatePicker:', showDatePicker, 'showTimePicker:', showTimePicker);
  
  if (showDatePicker) {
    console.log('📅 Treatments Date Modal should be visible');
  }
  
  if (showTimePicker) {
    console.log('⏰ Treatments Time Modal should be visible');
  }
          ...
          >
            ...
            <ScrollView style={styles.timeScrollContainer}>
              {Array.from({ length: 48 }, (_, i) => {
                ...
                // 24 saat formatında 00:00 - 23:30 arası
