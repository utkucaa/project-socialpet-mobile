...
export const AppointmentsPanel: React.FC<AppointmentsPanelProps> = ({ petId }) => {
  ...
  const resetForm = () => {
    ...
    // Reset to today's date and 9 AM for pickers but don't auto-fill
    ...
    // Keep fields empty - user should select
  };
              ...
              {!showDatePicker && !showTimePicker && (
                <>
                  ...
                  <ScrollView style={styles.modalContent}>
                    ...
                    <View style={styles.inputGroup}>
                      <Text style={styles.label}>Randevu Tarihi * (YYYY-MM-DD)</Text>
                      <TextInput
                        style={styles.textInput}
                    ...
                    <View style={styles.inputGroup}>
                      <Text style={styles.label}>Randevu Saati * (HH:MM)</Text>
                      <TextInput
                        style={styles.textInput}
