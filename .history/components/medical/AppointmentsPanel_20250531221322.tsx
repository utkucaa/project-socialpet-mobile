...
export const AppointmentsPanel: React.FC<AppointmentsPanelProps> = ({ petId }) => {
  ...
  const getSampleAppointments = (): Appointment[] => [
    ...
    },
    {
      ...
      reason: 'Aşı Randevusu',
      veterinarian: 'Dr. Ayşe Demir',
      notes: 'Karma aşı uygulaması'
    },
    {
      id: 'sample-3',
  ...
  const fetchAppointments = async () => {
    ...
    try {
      ...
      const transformedAppointments: Appointment[] = response.map((item: any) => {
        const appointmentDateTime = new Date(item.date);
      ...
      if (transformedAppointments.length === 0) {
        console.log('No appointments found, showing sample data for testing');
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const dateTimeString = `${date}T${appointmentTime}:00`;
          ...
          <View style={styles.modalContainer}>
            ...
            <ScrollView style={styles.modalContent}>
              ...
              <View style={styles.inputGroup}>
                ...
                >
                  <Text style={[styles.datePickerButtonText, {color: date ? '#1f2937' : '#9CA3AF'}]}>
