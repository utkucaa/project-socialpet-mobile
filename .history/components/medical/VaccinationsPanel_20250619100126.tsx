...
export const VaccinationsPanel: React.FC<VaccinationsPanelProps> = ({ petId }) => {
  ...
  // Removed sample data - users should add their own vaccinations
  ...
  const resetForm = () => {
    ...
    // Reset date picker to current date and set vaccinationDate
    ...
    // Set the default date in the correct format
    const todayFormatted = `${year}-${month}-${day}`;
    setVaccinationDate(todayFormatted);
  };
