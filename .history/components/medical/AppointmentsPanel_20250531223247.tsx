...
export const AppointmentsPanel: React.FC<AppointmentsPanelProps> = ({ petId }) => {
  ...
  const resetForm = () => {
    ...
    // Reset to today's date and 9 AM
          ...
          <View style={styles.pickerModalContainer}>
            ...
            <View style={styles.pickerContent}>
              ...
              <View style={styles.pickerButtonContainer}>
                ...
                >
                  <Text style={styles.pickerSelectButtonText}>Seç</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
            ...
            <View style={styles.pickerContent}>
              <ScrollView style={styles.timeScrollContainer}>
                ...
                {Array.from({ length: 21 }, (_, i) => {
                  ...
                  const displayTime = timeDate.toLocaleTimeString('tr-TR', { 
                    hour: '2-digit', 
                    minute: '2-digit',
                    hour12: false 
                  });
                  
                  const isSelected = selectedTime.getHours() === hour && selectedTime.getMinutes() === minute;
