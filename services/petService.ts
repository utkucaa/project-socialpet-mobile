...
export const ANIMAL_SPECIES = {
  ...
  'muhabbet kuşu': [
    'Standart', 'Jumbo', 'English Budgie', 'Lutino', 'Albino', 'Pied', 'Spangle', 'Diğer'
  ],
  papağan: [
    'Cennet Papağanı', 'Sultan Papağanı', 'Kakadu', 'Ara Papağanı', 
    'Afrika Grisi', 'Amazon Papağanı', 'Conure', 'Diğer'
  ]
};
